    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listening_offers', models.BooleanField(default=False)),
                ('public', models.BooleanField(default=False)),
                ('listed', models.BooleanField(default=False)),
                ('published', models.BooleanField(default=False)),
                ('display_email', models.BooleanField(default=False)),
                ('headline', models.CharField(default='Engineer / Doctor / Architech', max_length=32)),
                ...
                ('categories', models.ManyToManyField(blank=True, related_name='user_categories', to='resume.skillcategory')),
